import { hookup, reply, message } from "./broadcaster.mjs";
// @ts-ignore
import io from "./socket.mjs";
import { DiceRoller } from "./rpg-dice-roller.mjs";
// @ts-ignore
import { toast } from "./notifyjs.mjs";
...
class SocketManager {
    ...
    inbox(data) {
        ...
        switch (data.type) {
            ...
            case "remove-pin":
                if (this.isConnected && this.inRoom) {
                    this.socket.emit("remove-pin", data.uid);
                }
                break;
            case "add-entity":
                if (this.isConnected && this.inRoom) {
            ...
            case "join":
                if (!this.inRoom) {
                    this.socket.emit("join", {
                        ...
                        characterUid: (_a = data === null || data === void 0 ? void 0 : data.characterUid) !== null && _a !== void 0 ? _a : null,
                    });
                }
                break;
            case "roll-dice":
