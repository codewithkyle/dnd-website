class AttackComponent extends HTMLElement {
    ...
    update() {
        ...
        this.state.attacks.map((attack, index) => {
            const row = document.createElement("tr"), nameCell = document.createElement("td"), attackCell = document.createElement("td"), typeCell = document.createElement("td");
            const nameInput = document.createElement("input"), attackInput = document.createElement("input"), typeInput = document.createElement("input");
