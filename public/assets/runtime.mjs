...
import { fetchCSS, fetchJS } from "./fetch.mjs";
import { djinnjsOutDir, disablePjax, usePercentage } from "./config.mjs";
class Runtime {
    constructor() {
        this.handleLoadEvent = this.init.bind(this);
        this.intersectionCallback = this.handleIntersection.bind(this);
    ...
    fetchPjaxResources(data, requestUid) {
     ...
     */
    upgradeToWebComponent(customElementTagName, customElement) {
